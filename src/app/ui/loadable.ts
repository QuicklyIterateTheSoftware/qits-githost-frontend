...
/**
 * What a page knows about the thing it is showing.
 *
 * Copied from spa-artifacts rather than shared: there is no place to put it yet —
 * @qits/ui-components carries presentational components, not application types.
 */
